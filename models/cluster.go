...
const (
	...
	ClusterStatusProvisionFailedRollbackSuccess = "provision_failed_rollback_success"
	ClusterStatusProvisionFailedRollbackFailed  = "provision_failed_rollback_failed"
